...
function populateListProductChoices(slct1, slct2) {
    ...
    var optionArray3 =restrictListImages(products,s1.value);
	...
	for (i = 0; i < optionArray.length; i++) {
		...
		//show_image(productImage, 200, 200, productName); 

		
		var num=optionArray.length;
		...
		var src = document.getElementById("imgContainer");
...
function allergy(num){
	...
	para2.appendChild(document.createTextNode("poop"));
	para2.appendChild(document.createElement("br"));
	chosenProducts.push(num);
