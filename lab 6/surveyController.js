...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        var firstn = readData("firstn");
        var lastn = readData("lastn");
        ...
        var q5 = readData("q5");
        var q6 = readData("q6");
        res.render('showResults', {results: [firstn, lastn, age, gender, q1, q2, q3, q4, q5, q6]});
        console.log([firstn, lastn, age, gender, q1, q2, q3, q4, q5, q6]);
    });
